...
|------------|----------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|
| 1          | (avec  M = Nb max instructions) (Nb miss pour instructions numérotées [j $\times$ step ,j $\times$ step+step] pour  j dans [1,M//step]) | Nombre de coordonées en commun entre deux vecteurs Les vecteurs ont tous la meme taille.                                                                                                         | Nombre de vecteurs distincts |
